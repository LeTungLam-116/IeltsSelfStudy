...
import Footer from "../../components/home/Footer"; // Assuming Footer is in home/Footer based on CoursesPage usage

// Basic LayoutContainer component to ensure consistency if the imported one fails or is different
...
export default function ListeningListPage() {
  ...
  // Filter exercises: Must be 'Listening' type + match search + match level
  const filteredExercises = useMemo(() => {
    return exercises.filter((ex) => {
      const isListening = ex.type.toLowerCase() === 'listening';
      ...
      return isListening && matchesSearch && matchesLevel;
    });
  ...
  if (isLoading) {
    return (
      <div style={{ padding: "100px 0", textAlign: "center", minHeight: "60vh" }}>
        ...
        <p style={{ color: "#64748b", fontWeight: 500 }}>Đang tải bài tập Listening...</p>
      </div>
    );
  }
        ...
        <LayoutContainer>
          <div className="text-center mb-10">
            <h1 className="text-3xl md:text-4xl font-black text-slate-800 mb-4 tracking-tight">
              Thư Viện Bài Tập <span className="text-blue-600">Listening</span> 🎧
            </h1>
            <p className="text-lg text-slate-500 max-w-2xl mx-auto leading-relaxed">
              Luyện nghe tiếng Anh hiệu quả với kho bài tập đa dạng, từ cơ bản đến nâng cao.
              Cải thiện kỹ năng nghe hiểu và chuẩn bị tốt nhất cho kỳ thi IELTS.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative mb-8">
              ...
              <input
                ...
                className="w-full py-4 pl-14 pr-5 rounded-2xl border-2 border-slate-100 bg-slate-50 text-base focus:border-blue-500 focus:bg-white focus:outline-none transition-all duration-200 shadow-sm"
              />
            </div>
